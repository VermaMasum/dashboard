...
const EmployeeDashboard = () => {
  ...
  const fetchDashboardData = React.useCallback(async () => {
    ...
    try {
      ...
      const todayHours = todayReports.reduce(
                    ...
                    <CardContent>
                      ...
                      {recentReports.length === 0 ? (
                        <Box textAlign="center" py={6}>
                          ...
                          >
                            Start tracking your daily work by creating your
                            first report
                          </Typography>
                          <Button
                            variant="contained"
          ...
          {activeTab === 3 && (
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" paragraph>
                View your weekly work summary, project breakdown, and team
                overview.
              </Typography>
              <Button
                variant="contained"
                color="primary"
                onClick={() =>
                  window.open("/employee/weekly-reports", "_blank")
                }
                sx={{ mt: 2 }}
              >
                Open Weekly Reports
