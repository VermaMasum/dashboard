...
const AdminDashboard = () => {
  ...
  // Report view state
  const [reportView, setReportView] = useState<"daily" | "weekly" | "monthly">(
    "daily"
  );
  ...
  const getDailyReports = () => {
    ...
    if (selectedEmployee) {
      filtered = filtered.filter(
        (report) => report.employee?._id === selectedEmployee
      );
    }
        ...
        {error && (
          <Alert severity="error" sx={{ mb: 2 }} onClose={() => setError("")}>
            ...
            <Typography variant="body2" sx={{ mt: 1 }}>
              Please check the console for more details and try refreshing the
              page.
            </Typography>
          </Alert>
        )}
                  ...
                  <TableBody>
                    {getDailyReports().map((report) => (
                      ...
                      >
                        ...
                        <TableCell>
                          {report.employee?.username || "Unknown Employee"}
                        </TableCell>
                        <TableCell>
                          <Typography
                            variant="body2"
